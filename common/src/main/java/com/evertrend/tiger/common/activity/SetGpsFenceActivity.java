...
import com.evertrend.tiger.common.widget.CombinationOverlay;

import java.util.ArrayList;
import java.util.List;

public class SetGpsFenceActivity extends AppCompatActivity {
    public static final String TAG = "SetGpsFenceActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yl_common_set_activity_gps_fence);
...
//                            mBaiduMap.showInfoWindow(infoWindow);
    ...
    private void createPopupView(String title, View.OnClickListener left,View.OnClickListener right) {
        if (popupView == null) {
            popupView = LayoutInflater.from(this).inflate(R.layout.yl_common_listformat_popview_new, null);
